...
if __name__ == "__main__":
    dicom_path = r"C:\Users\views\PycharmProjects\TCIA_Lymphoma_data\DICOM"
    out_path = r"C:\Users\views\PycharmProjects\TCIA_Lymphoma_data\NIFTI"
    path_to_data = plb.Path(dicom_path)  # path to downloaded TCIA DICOM database, e.g. '.../FDG-PET-CT-Lesions/'
    nii_out_root = plb.Path(out_path)  # path to the to be created NiFTI files, e.g. '...tcia_nifti/FDG-PET-CT-Lesions/')
